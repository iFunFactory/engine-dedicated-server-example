...
#ifndef DEDI_SERVER_EXAMPLE_ENGINE_SRC_DSM_SESSION_RESPONSE_H_
#define DEDI_SERVER_EXAMPLE_ENGINE_SRC_DSM_SESSION_RESPONSE_H_
...
#endif  // DEDI_SERVER_EXAMPLE_ENGINE_SRC_DSM_SESSION_RESPONSE_H_
